...
angular.module('hongcaiApp')
  .controller('TransferTransferCtrl', ['$scope', '$state', '$rootScope', 'toaster', '$stateParams', 'UserCenterService', 'config', function ($scope, $state, $rootScope, toaster, $stateParams, UserCenterService, config) {
    function newForm() {
